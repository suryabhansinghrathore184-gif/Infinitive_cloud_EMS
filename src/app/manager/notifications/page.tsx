  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-2xl font-extrabold text-slate-900 tracking-tight">Manager Notifications</h1>
          <p className="text-sm text-slate-500 mt-1">Stay updated with team requests, leave alerts, and system notifications.</p>
        </div>
